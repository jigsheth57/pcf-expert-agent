...
* **Role Creation (Prompt Engineering):** A **system role/prompt** is created for the **gemma3n chat model** to establish it as a **TAS for VMs expert** that must operate within a strict **contextual boundary**.
